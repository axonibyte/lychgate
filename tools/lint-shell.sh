...
files="tools/check.sh tools/lint-shell.sh tools/install-service.sh tools/install-service-test.sh rc.d/lychgated e2e/ssh-acceptance.sh e2e/revert-under-kill.sh e2e/service-start.sh e2e/run.sh"
